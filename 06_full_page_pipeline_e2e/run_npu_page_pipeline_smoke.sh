...
echo "NPU_PAGE_PIPELINE_ENV ACTIVE_BATCH_SIZE=${ACTIVE_BATCH_SIZE} PAGE_CHUNK_SIZE=${PAGE_CHUNK_SIZE} CACHE_LENGTH=${CACHE_LENGTH} MAX_NEW_TOKENS=${MAX_NEW_TOKENS}"
echo "NPU_PAGE_PIPELINE_ENV LAYOUT_SOURCE=${LAYOUT_SOURCE} EXPECT_LAYOUT_SOURCE=${EXPECT_LAYOUT_SOURCE} EXPECTED_RECOGNIZER_CROPS=${EXPECTED_RECOGNIZER_CROPS:-auto-if-first64-gt}"
