...
export VISION_FORWARD_BOUNDARY="${VISION_FORWARD_BOUNDARY:-get_image_features}"
...
echo "VISION_PREFILL_ONLY_ENV VISION_COMPILE_BACKEND=${VISION_COMPILE_BACKEND} VISION_COMPILE_VALIDATE=${VISION_COMPILE_VALIDATE} VISION_FORWARD_BOUNDARY=${VISION_FORWARD_BOUNDARY}"
...
summary = {
    ...
    "vision_forward_boundary": data.get("vision_forward_boundary"),
    ...
    "profiler": {
        ...
        "profile_context_wall_s": (data.get("profiler") or {}).get("profile_context_wall_s"),
        "profile_active_loop_wall_s": (data.get("profiler") or {}).get("profile_active_loop_wall_s"),
        "profile_forward_sync_sum_s": (data.get("profiler") or {}).get("profile_forward_sync_sum_s"),
        "profile_profiler_step_sum_s": (data.get("profiler") or {}).get("profile_profiler_step_sum_s"),
        "profile_context_non_active_s": (data.get("profiler") or {}).get("profile_context_non_active_s"),
        "profile_active_loop_unattributed_s": (data.get("profiler") or {}).get("profile_active_loop_unattributed_s"),
        "profiled_context_wall_vision_tokens_per_s": ((data.get("profiler") or {}).get("profiled_context_wall_result") or {}).get("vision_tokens_per_s"),
        "profiled_forward_sync_vision_tokens_per_s": ((data.get("profiler") or {}).get("profiled_forward_sync_result") or {}).get("vision_tokens_per_s"),
    },
