...
echo "VISION_PREFILL_PROFILE_COMPARE_ENV VISION_COMPILE_BACKEND=${VISION_COMPILE_BACKEND} VISION_COMPILE_VALIDATE=${VISION_COMPILE_VALIDATE} VISION_FORWARD_BOUNDARY=${VISION_FORWARD_BOUNDARY}"
...
summary = {
    ...
    "vision_forward_boundary": on.get("vision_forward_boundary"),
    "vision_compile": on.get("vision_compile"),
