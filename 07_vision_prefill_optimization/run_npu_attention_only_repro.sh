...
SAFE_NAME="attn_${ATTENTION}_layout_${PROMPTFA_LAYOUT}_boundary_${INPUT_BOUNDARY}_backend_${COMPILE_BACKEND}_mask_${MASK_KIND}_rank_${MASK_RANK}_nopad_${NO_PADDING}_eagerly_${TORCHAIR_RUN_EAGERLY}"
