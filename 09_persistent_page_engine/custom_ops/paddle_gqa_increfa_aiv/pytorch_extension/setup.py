...
setup(
    name="paddle_gqa_increfa_aiv_eager",
    version="0.1.0",
    packages=find_packages(),
    ext_modules=[
        NpuExtension(
            name="paddle_gqa_increfa_aiv_eager._C",
            sources=[str(ROOT / "csrc/paddle_gqa_increfa_aiv_eager.cpp")],
            extra_compile_args=[
                "-O3", "-std=c++17",
    ...
    cmdclass={"build_ext": BuildExtension.with_options(use_ninja=os.environ.get("USE_NINJA") == "1")},
)
