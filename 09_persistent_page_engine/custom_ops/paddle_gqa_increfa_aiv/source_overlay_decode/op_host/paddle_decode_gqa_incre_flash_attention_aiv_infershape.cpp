    ...
    gert::InferShapeContext *context)
{
    if (context == nullptr || context->GetInputShape(0) == nullptr ||
        context->GetInputShape(3) == nullptr || context->GetInputShape(7) == nullptr ||
        context->GetInputShape(8) == nullptr ||
    ...
    *context->GetOutputShape(0) = *context->GetInputShape(0);
    // With one tensor in each dynamic K/V group and omitted optional inputs,
    // the required K/V ref aliases are compact runtime inputs 7 and 8.
    *context->GetOutputShape(1) = *context->GetInputShape(7);
    *context->GetOutputShape(2) = *context->GetInputShape(8);
    ...
    gert::InferDataTypeContext *context)
{
    ...
    context->SetOutputDataType(1, context->GetInputDataType(7));
    context->SetOutputDataType(2, context->GetInputDataType(8));
