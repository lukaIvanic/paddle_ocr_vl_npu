...
extern aclnnStatus aclnnInnerPaddleMhaIncreFlashAttentionAivGetWorkspaceSize(
...
extern aclnnStatus aclnnInnerPaddleMhaIncreFlashAttentionAiv(
    void *workspace,
    uint64_t workspaceSize,
    aclOpExecutor *executor,
...
aclnnPaddleMhaIncreFlashAttentionAivGetWorkspaceSize(
    ...
    aclOpExecutor **executor)
{
    return aclnnInnerPaddleMhaIncreFlashAttentionAivGetWorkspaceSize(
        query,
        key,
        value,
        pseShift,
...
aclnnPaddleMhaIncreFlashAttentionAiv(
    ...
    const aclrtStream stream)
{
    return aclnnInnerPaddleMhaIncreFlashAttentionAiv(
        workspace,
        workspaceSize,
        executor,
        stream);
