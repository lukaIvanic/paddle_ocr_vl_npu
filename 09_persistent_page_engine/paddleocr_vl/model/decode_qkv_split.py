...
GE_QUERY_OP_NAME = "PaddleDecodeQuerySliceV1"
GE_KEY_OP_NAME = "PaddleDecodeKeySliceV1"
GE_VALUE_OP_NAME = "PaddleDecodeValueSliceV1"
GE_OP_NAME = ",".join(
    (GE_QUERY_OP_NAME, GE_KEY_OP_NAME, GE_VALUE_OP_NAME)
)
PYTORCH_QUERY_OP_NAME = "paddleocr_vl::decode_query_slice_v1"
PYTORCH_KEY_OP_NAME = "paddleocr_vl::decode_key_slice_v1"
PYTORCH_VALUE_OP_NAME = "paddleocr_vl::decode_value_slice_v1"
...
def register_decode_qkv_split_converter() -> None:
    ...
    @register_converter(torch.ops.paddleocr_vl.decode_query_slice_v1.default)
    ...
    @register_converter(torch.ops.paddleocr_vl.decode_key_slice_v1.default)
    ...
    @register_converter(torch.ops.paddleocr_vl.decode_value_slice_v1.default)
