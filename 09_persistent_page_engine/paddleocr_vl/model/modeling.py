#!/usr/bin/env python3
"""Local PaddleOCR-VL model implementation without Transformers imports."""
...
if TYPE_CHECKING:
    from .text_decode import TextDecodeRuntime
    from .text_prefill import TextPrefillRuntime
    from .vision_prefill import VisionPrefillRuntime
...
class LocalPaddleOCRVLForConditionalGeneration(nn.Module):
    ...
    def make_inference_stages(
        ...
        *,
        ...
        # Local imports avoid a module cycle: each stage imports the concrete
        # model classes and compiler-safe math helpers defined above.
        from .text_decode import TextDecodeRuntime
        from .text_prefill import TextPrefillRuntime
        from .vision_prefill import VisionPrefillRuntime
