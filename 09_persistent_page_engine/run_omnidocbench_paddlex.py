...
DEFAULT_CACHE_ROOT = Path(".runtime_cache/09_persistent_page_engine_torchair")
DEFAULT_VISION_CACHE_ROOT = Path(".runtime_cache/09_persistent_page_engine_vision_torchair")
DEFAULT_TEXT_CACHE_ROOT = Path(".runtime_cache/09_persistent_page_engine_text_torchair")
