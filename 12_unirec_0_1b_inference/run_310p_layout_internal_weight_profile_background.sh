...
print(
    ...
    f"native_depthwise_fz={native['depthwise_nchw_fz_count']}/{native['depthwise_nchw_fz_ms']:.6f}ms "
    f"internal_depthwise_fz={internal['depthwise_nchw_fz_count']}/{internal['depthwise_nchw_fz_ms']:.6f}ms "
