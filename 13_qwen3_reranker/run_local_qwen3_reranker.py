...
class LocalQwen3RerankerRunner:
    ...
    def load_model(self) -> LocalQwen3RerankerForCausalLM:
        ...
        elif self.ffn_weight_mode == "down_w8a8":
            from local_reranker_w8a8 import quantize_reranker_down_inplace

            quantize_reranker_down_inplace(model, out_dtype=self.dtype)
