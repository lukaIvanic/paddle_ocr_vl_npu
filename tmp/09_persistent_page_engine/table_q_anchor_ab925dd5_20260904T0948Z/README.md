...
| Lane | Static KV length | Median call | P95 call | Calls/s | Physical positions/s |
|---|---:|---:|---:|---:|---:|
| B8Q1 | 768 tokens | 1.094 ms | 1.101 ms | 908.5 | 7,268.3 |
| B1Q8 | 4,096 tokens | 1.338 ms | 1.351 ms | 743.5 | 5,947.9 |
| B16Q1 | 768 tokens | 1.357 ms | 1.365 ms | 735.5 | 11,768.4 |
| B1Q16 | 4,096 tokens | 1.914 ms | 1.919 ms | 520.9 | 8,334.5 |
