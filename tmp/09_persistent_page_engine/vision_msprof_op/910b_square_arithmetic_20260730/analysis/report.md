...
- Capture metric: `ArithmeticUtilization`
- Capture directory: `/workspace/repos/paddle_ocr_vl_npu/tmp/09_persistent_page_engine/vision_msprof_op/910b_square_arithmetic_20260730`
- Raw directory: `/workspace/repos/paddle_ocr_vl_npu/.runtime_cache/09_persistent_page_engine_vision_msprof_op/910b_square_arithmetic_20260730`
...
| --- | --- | --- | --- | --- |
| square | 29.540 | 29.540 | 807.260 | q_proj=23.504, k_proj=23.122, v_proj=23.266, out_proj=29.153 |
...
| --- | --- | --- | --- | --- | --- | --- |
| Pipe.MTE1.active bw(GB/s) | 24 | 0 | 0 | 247.464 | 242.553 | 252.516 |
| Pipe.MTE2.active bw(GB/s) | 24 | 0 | 24 | 0.000 | 0.000 | 0.000 |
