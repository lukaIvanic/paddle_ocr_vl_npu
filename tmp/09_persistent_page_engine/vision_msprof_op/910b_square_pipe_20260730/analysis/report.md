...
- Capture metric: `PipeUtilization`
- Capture directory: `/workspace/repos/paddle_ocr_vl_npu/tmp/09_persistent_page_engine/vision_msprof_op/910b_square_pipe_20260730`
- Raw directory: `/workspace/repos/paddle_ocr_vl_npu/.runtime_cache/09_persistent_page_engine_vision_msprof_op/910b_square_pipe_20260730`
...
| --- | --- | --- | --- | --- |
| square | 29.440 | 29.440 | 815.520 | q_proj=23.504, k_proj=23.122, v_proj=23.266, out_proj=29.153 |
...
| --- | --- | --- | --- | --- | --- | --- |
| Pipe.MTE1.active bw(GB/s) | 24 | 0 | 0 | 246.216 | 241.406 | 249.153 |
