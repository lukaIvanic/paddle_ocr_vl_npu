...
/workspace/venvs/vllm_paddle_ocr_pipeline_py312/bin/python \
  ...
  --output-dir tmp/12_unirec_0_1b_inference/opendoc_continuous_b32_32p_warm_919a26c/output \
  --device npu:0 --dtype float16 --max-length 256 \
  --decode-mode compiled --compile-backend torchair \
  --compile-cache-dir .runtime_cache/12_unirec_0_1b_inference/opendoc_continuous_b32 \
  --decode-batch-size 32 --decode-scheduling continuous --limit 32
